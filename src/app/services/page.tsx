...
const services = [
  // ติดตั้ง
  {
    ...
    description:
      '“รู้จัก ‘พื้นอีพ็อกซี่’ พื้นสุดแกร่งที่ครองใจทุกอุตสาหกรรม” และใช้งานได้หลากหลาย ไม่ว่าจะในโรงงาน โกดัง หรือพื้นที่เชิงพาณิชย์ — พื้นอีพ็อกซี่คือคำตอบ! แล้วคุณล่ะกำลังมองหาพื้นที่ตอบโจทย์ธุรกิจอยู่หรือเปล่า?',
  },
  {
    id: 2,
    category: 'งานติดตั้ง',
...
export default function ServicesPage() {
  ...
  const openModal = (service: any) => setSelectedService(service)
